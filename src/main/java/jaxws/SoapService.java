 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://jaxws/", wsdlLocation = "http://localhost:8080/EEjms_war_exploded/Soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://jaxws/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EEjms_war_exploded/Soap?wsdl");
     ...
     * 
     * @return
     *     returns InterSoapSAI
     */
    @WebEndpoint(name = "SoapPort")
    public InterSoapSAI getSoapPort() {
        return super.getPort(new QName("http://jaxws/", "SoapPort"), InterSoapSAI.class);
    }
     ...
     */
    @WebEndpoint(name = "SoapPort")
    public InterSoapSAI getSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws/", "SoapPort"), InterSoapSAI.class, features);
    }
